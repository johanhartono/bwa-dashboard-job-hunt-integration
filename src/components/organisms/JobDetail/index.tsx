      ...
      <div className="grid grid-cols-3 w-full gap-5">
        <div className="col-span-2 space-y-10">
          <div>
            ...
            molestiae, assumenda inventore, sequi nemo ullam voluptas magni
            voluptatibus at sint molestias repellendus aperiam, modi adipisci
            obcaecati pariatur. Obcaecati, quia ipsum.
          </div>
          <div>
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0, 1, 2].map((item: number) => (
            <div key={item}>
              ...
              <div className="text-gray-500" />
              We believe in thriving communitoes and that starts with our team
